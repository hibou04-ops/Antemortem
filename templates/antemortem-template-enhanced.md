# Antemortem (enhanced) — <change name>
...
**Version:** enhanced v0.1 (2026-04-20). Incorporates calibration dimensions, fine-grained classification, explicit skeptic pass, and decision-first output from v2+ architecture notes. Compatible with `docs/methodology.md` seven-step protocol — the protocol is unchanged; the doc structure just gets richer.
