...
- The Antemortem methodology — the seven-step protocol, the
  `REAL` / `GHOST` / `NEW` / `UNRESOLVED` risk classification scheme, and the
  pre-implementation reconnaissance discipline
- All templates, case studies, and reference materials in this repository
- Documentation (README, EASY_README, methodology papers)
- The name "Antemortem" as used to label the discipline

## Contributors

External contributions are accepted under the terms of [CONTRIBUTING.md](CONTRIBUTING.md)
and the Apache License 2.0. Contributors retain copyright in their own contributions
and grant the project a license under Apache 2.0 §5.
